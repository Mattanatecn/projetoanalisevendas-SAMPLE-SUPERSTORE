...
Este documento registra as principais perguntas de negócio, hipóteses investigadas, métodos utilizados e conclusões do projeto.

O objetivo é separar o raciocínio analítico dos códigos exploratórios. O notebook mostra os cálculos; este arquivo mostra a linha de pensamento da análise.
